...
- **縦型UIモード**: スマートフォンでの操作に最適化したプレイ環境（Ver 0.1.19）。
...
## 📝 最新の更新 (Ver 0.1.19)
- **縦型UIの実装**: スマートフォンの縦持ち操作に最適化したレイアウトを追加。
- **モバイルロードマップの更新**: UI選択オプションの基盤を整備。
- **ドキュメントの整理**: モバイル対応計画と自動テストガイドを最新化。
