...
## 📝 最新の更新 (Ver 0.1.38)
- **オートスクロールの全面導入**: `PlayTestClient` および `PlayTest1080pClient` の両方で、プレイヤー中心のカメラオフセット計算を実装。
- **レンダリングの最適化**: `translate3d` を使用したハードウェア加速によるスムーズなスクロールを実現。
