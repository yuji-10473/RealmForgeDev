      ...
      >
        ...
        <div
          className={cn(
            ...
            "group-data-[state=collapsed]:w-[--sidebar-width-icon]", // Adjusted width for icon only
        ...
        <div
          className={cn(
            ...
            "group-data-[state=collapsed]:w-[--sidebar-width-icon]", // Collapsed width
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ref={ref}
      data-sidebar="footer"
      className={cn("p-2", className)} // Simplified styling
      {...props}
    />
  )
})
...
>(({ className, ...props }, ref) => (
  <ul
    ref={ref}
    data-sidebar="menu"
    className={cn("flex w-full min-w-0 flex-col gap-1 px-2", className)} // Add padding for icon alignment
    {...props}
  />
))
    ...
    <>
      {React.Children.map(children, (child) => {
        if (React.isValidElement(child) && child.type === "span") {
          return (
            <span className="truncate group-data-[state=collapsed]:opacity-0 group-data-[state=collapsed]:w-0 transition-opacity duration-200">
  ...
  const button = (
    <Comp
      ...
      className={cn(
        ...
        "group-data-[state=collapsed]:w-10 group-data-[state=collapsed]:justify-center", // Icon-only style
        className
      )}
      {...props}
    >
